...
const PerfilAlunoEdicao = ({ dados, onSalvar, onCancelar }) => {
  ...
  return (
    ...
    >
      ...
      <CampoEdicao
        ...
        valor={form.matriz}
        onChange={handleChange("matriz")}
      />
      <CampoEdicao
        label="Período de Referência"
        valor={form.periodoReferencia}
        onChange={handleChange("periodoReferencia")}
      />
      <CampoEdicao
        label="Situação"
        valor={form.situacao}
...
export default PerfilAlunoEdicao;
